...
TEST(CompactionState, HasContiguousRangeMany) {
    cs state;
    for (int i = 0; i < 10; ++i) {
        ASSERT_TRUE(state.add(make_tombstone_range(i * 10, i * 10 + 9, 1000)));
    }
...
TEST(CompactionState, HasContiguousRangeManyNonUniform) {
    ...
    for (auto [base, last] : std::initializer_list<std::pair<int, int>>{
           {120198, 120282}, {120283, 120383}, {120384, 120495},
           {120496, 120597}, {120598, 120707}, {120708, 120796},
           {120797, 120893}, {120894, 120992}, {120993, 121091},
           {121092, 121184}, {121185, 121187}, {121188, 121268},
           {121269, 121374}, {121375, 121485}, {121486, 121587},
           {121588, 121693}, {121694, 121785}, {121786, 121881},
           {121882, 121979},
         }) {
