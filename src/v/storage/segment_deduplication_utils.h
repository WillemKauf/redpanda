...
// Puts an entry within the `key_offset_map`, returning `ss::stop_iteration::no`
// on success and `ss::stop_iteration::yes` on failure.
...
// in the compaction::key_offset_map that is not the latest offset for that key.
